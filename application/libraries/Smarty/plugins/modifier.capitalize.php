 ...
 *
 * {@internal {$string|capitalize:true:true} is the fastest option for MBString
 * enabled systems }}
 *
 * @param string $string
 ...
 *        	capitalize first letters, lowercase all following letters "aAa" to
 *        	"Aaa"
...
/*
 * Bug: create_function() use exhausts memory when used in long loops Fix: use
 * declared functions for callbacks instead of using create_function() Note:
 * This can be fixed using anonymous functions instead, but that requires PHP >=
 * 5.3 @author Kyle Renfrow
 */
