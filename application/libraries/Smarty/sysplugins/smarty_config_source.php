...
class Smarty_Config_Source extends Smarty_Template_Source {
	...
	public function __construct(Smarty_Resource $handler, Smarty $smarty, $resource, $type, $name, $unique_resource) {
		...
		// Note: these may be ->config_compiler_class etc in the future
		                           // $this->config_compiler_class =
		                           // $handler->config_compiler_class;
		                           // $this->config_lexer_class =
		                           // $handler->config_lexer_class;
		                           // $this->config_parser_class =
		                           // $handler->config_parser_class;
