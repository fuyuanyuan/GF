...
abstract class Smarty_Internal_TemplateCompilerBase {
	...
	public function compileTemplate(Smarty_Internal_Template $template, $nocache = false) {
		...
		$loop = 0;
		// the $this->sources array can get additional elements while compiling
		// by the {extends} tag
		...
		// unset content because template inheritance could have replace source
		// with parent code
	...
	public function compileTag($tag, $args, $parameter = array()) {
		...
		// compile the smarty tag (required compile classes to compile the tag
		// are autoloaded)
	 ...
	 * If the content is compiled code and it should be not cached the code is
	 * injected
	...
	public function processNocacheCode($content, $is_code) {
		// If the template is not evaluated and we have a nocache section and or
		// a nocache tag
	...
	/**
	 * push current file and line offset on stack for tracing {block} source
	 * lines
	 *
	 * @param string $file
	 *        	new filename
	 ...
	 * In this case the parser is called to obtain information about expected
	 * tokens.
	 *
