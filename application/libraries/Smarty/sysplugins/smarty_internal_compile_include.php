...
class Smarty_Internal_Compile_Include extends Smarty_Internal_CompileBase {
	...
	public function compile($args, $compiler, $parameter) {
		...
		// $compiler->tag_nocache || $compiler->forceNocache == 2)) {
		...
		/*
		 * if the {include} tag provides individual parameter for caching it
		 * will not be included into the common cache file and treated like a
		 * nocache section
		 */
