...
class Smarty_Internal_Resource_PHP extends Smarty_Resource_Uncompiled {
	/**
	 * container for short_open_tag directive's value before executing PHP
	 * templates
	 * 
	 * @var string
	 */
	 ...
	 *        	template object
	 * @return void
	 * @throws SmartyException if template cannot be loaded or
	 *         allow_php_templates is disabled
	 */
