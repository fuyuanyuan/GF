...
class Smarty_Internal_Config {
	 ...
	 *
	 * It does compare the timestamps of config source and the compiled config
	 * and checks the force compile configuration
	 *
	 ...
	 *
	 * It checks if the config file must be compiled or just read the compiled
	 * version
	 *
