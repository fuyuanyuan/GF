<?php /* Smarty version Smarty-3.1.18, created on 2014-06-15 16:47:58
         compiled from "application\views\admin\role\add.html" */ ?>
<?php /*%%SmartyHeaderCode:21868539d5dbec4e1d8-77869666%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '96d1cd103dfa8804d6cca698388e2cc3d5829fcc' => 
    array (
      0 => 'application\\views\\admin\\role\\add.html',
      1 => 1402052934,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21868539d5dbec4e1d8-77869666',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_539d5dbede4632_39880012',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_539d5dbede4632_39880012')) {function content_539d5dbede4632_39880012($_smarty_tpl) {?><?php if (!is_callable('smarty_function_base_url')) include 'C:\\AppServ\\www\\GF\\application\\libraries\\Smarty\\plugins\\function.base_url.php';
...
">角色列表</a></span>
<span class="action-span1"><a href="#">GF_SHOP 管理中心</a> </span><span class="action-span1" id="search_id"> - 添加新角色</span>
...
<div class="tab-div">
  ...
  <div id="tabbody-div">
    <form name="theForm"  method="post" action="<?php echo smarty_function_base_url(array('url'=>'admin/role/add'),$_smarty_tpl);?>
">
    <table width="90%" id="general-table" style="display: table;">
      <tbody><tr>
        <td class="narrow-label">角色名称</td>
        <td><input type="text" value="" maxlength="60" size="40" name="role_name"><span class="require-field">*</span></td>
      </tr>
      <tr></tr><tr></tr>
